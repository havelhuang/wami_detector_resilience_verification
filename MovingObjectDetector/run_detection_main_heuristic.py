...
def run_detection_main_heuristic(attack, model_folder, imagefolder, input_image_idx, ROI_centre,
    ...
    for i in range(20):
        ...
        if i > 0:
            ...
            if (i > 5) and (i < 9) :
                # the id in the regressed detections
                # regressionID = kf_attack.NearestNeighbourAssociator(regressedDetections)
                Neighbours = kf_attack.NeighbourAssociation_direc(regressedDetections,old_kfz, old_kfmu)
